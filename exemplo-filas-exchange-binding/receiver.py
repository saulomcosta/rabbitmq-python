...
def callback(ch, method, properties, body):
    ...
    channel.basic_nack(
        ...
        requeue=True # Caso True, a mensagem seria reencaminhada para a fila original
    )
...
result = channel.queue_declare(
    ...
    arguments={
        ...
        "x-queue-type": "quorum", # Define a fila como do tipo Quorum, garantindo alta disponibilidade e tolerância a falhas
        "x-delivery-limit": 5 # Limita o número de entregas de uma mensagem antes de ser considerada "perdida" e movida para a DLX
    }
)
